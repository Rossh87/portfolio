...
// Get helper function to limit fire rate of scroll event handler.
...
function withHoverBehaviors(Wrapped) {
    class Hover extends React.Component {
        constructor(props) {
            ...
            // on scroll
            this._limitedAddScrollListener = limitFireRate(
                this.addScrollListener,
                200
            );
            this._limitedRemoveScrollListener = limitFireRate(
                this.removeScrollListener,
                200
            );
            this._limitedControlHoverForMobile = limitFireRate(
                this.controlHoverForMobile,
                200
            );
        }
        ...
        componentDidMount() {
            ...
            // Remove scroll-based hovering if wheel event generated by a mouse fires.
            window.addEventListener(
                "WheelIsMouse",
                this._limitedRemoveScrollListener.callback
            );
        ...
        componentWillUnmount() {
            ...
            if (this.state.hasScrollListener) {
                window.removeEventListener(
                    "scroll",
                    this._limitedControlHoverForMobile.callback
                );
            }
        ...
        controlHoverForMobile = () => {
            ...
            const breakPoint = hasBroken ? height / 2 : height / 3;
